    ...
    def test_modules(self):
        ...
        for module in imported_modules():
            if module not in allowed_modules:
                self.fail(
                    f'module {module} imported by submission but not allowed.')
...
class TestReferees(unittest.TestCase):
    ...
    def test_1(self):
        csvfilename = os.path.join(scriptDirectory, 'referees1.csv')
        games = {('Bob', 'Alice'), ('Joe', 'Charlie'), ('Elaine', 'Rene')}
        self.assertEqual(P.referees(games, csvfilename), {
            ('Bob', 'Alice'): 'Rene',
            ('Joe', 'Charlie'): 'David',
            ('Elaine', 'Rene'): 'Joe'
        })
    ...
    def test_2(self):
        ...
        self.assertEqual(P.referees(games, csvfilename), None)

    def test_3(self):
        csvfilename = os.path.join(scriptDirectory, 'referees2.csv')
        games = {
        ...
        r = P.referees(games, csvfilename)
        self.assertEqual(r, {
    ...
    def test_4(self):
        csvfilename = os.path.join(scriptDirectory, 'referees3.csv')
        games = {
...
class TestgameGroups(unittest.TestCase):
    ...
    def test_1(self):
        self.assertEqual(P.gameGroups(
            {('Alice', 'Bob'): 'Rene'}), [{('Alice', 'Bob')}])

    def checkGameGroups(self, assignedReferees, gameGroups):
        numgames = len(assignedReferees)
        games = set(assignedReferees.keys())
        self.assertEqual(sum(len(gameGroup)
                         for gameGroup in gameGroups), numgames)
...
class TestScores(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(P.scores(3, 2, 4, games), {
                         'Alice': 8, 'Bob': 3, 'Charlie': 0, 'Dave': 3})
